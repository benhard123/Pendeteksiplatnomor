...
def calibration (image):
   ...
   while True:
    ...
    imgOriginalScene2 = imgOriginalScene.copy()
    # give definition for each initial on image or windows
    cv2.putText(imgOriginalScene2,"Press 's' to save the value",(10,30),cv2.FONT_HERSHEY_SIMPLEX, 0.75,(255,255,255),2,bottomLeftOrigin = False)
    cv2.putText(imgOriginalScene2,"Press 'o' to out the value",(10,60),cv2.FONT_HERSHEY_SIMPLEX, 0.75,(255,255,255),2,bottomLeftOrigin = False)
    cv2.putText(imgOriginalScene2,"Press 'c' to check the result",(10,90),cv2.FONT_HERSHEY_SIMPLEX, 0.75,(255,255,255),2,bottomLeftOrigin = False)
    cv2.putText(imgOriginalScene2,"Press 'esc' to close all windows",(10,120),cv2.FONT_HERSHEY_SIMPLEX, 0.75,(255,255,255),2,bottomLeftOrigin = False)
    ...
    cv2.imshow("image2", imgOriginalScene2)
